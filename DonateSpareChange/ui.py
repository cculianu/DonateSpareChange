...
class Ui_Instance(object):
    def setupUi(self, Instance):
        ...
        self.fr_title.setMaximumSize(QtCore.QSize(16777215, 100))
    ...
    def retranslateUi(self, Instance):
        ...
        self.tree_charities.headerItem().setText(1, _translate("Instance", "Recipient Name"))
        self.tree_charities.headerItem().setText(2, _translate("Instance", "Recipient Address"))
        ...
        self.lbl_amount.setText(_translate("Instance", "\"Change\" amount theshold below:"))
